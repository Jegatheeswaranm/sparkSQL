package jegatheeswaran.spark.sql
...
//import jegatheeswaran.spark.sql.reusablefw._    
...
// CURATION from line step 3 to step 5
    ...
    println("create an object reusableobj to Instantiate the cleanup class present in jegatheeswaran.spark.sql.reusable pkg")
 ...
 /*   val maskobj=new jegatheeswaran.spark.sql.rufw.masking;
     val udfmask=udf(maskobj.hashmask _)
 */   
    val reusableobj=new jegatheeswaran.spark.sql.reusablefw.cleanup;
...
*/    
 ...
 //https://spark.apache.org/docs/2.3.0/api/sql/
    ...
    val reusableobj1=new jegatheeswaran.spark.sql.reusablefw.transform;
